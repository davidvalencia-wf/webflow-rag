...
category: general
url: https://developers.webflow.com/data/v1.0.0/reference/user-account-deleted
title: "User Account Deleted | Webflow Developer Documentation"
...
| `accessGroups` | array | array of access groups the user had access to |
