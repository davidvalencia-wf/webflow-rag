...
category: general
url: https://developers.webflow.com/flowkit/foundation/spacing
...
Variables can be remapped. For example, `0.25x` might be set to `0.5rem` based on your project’s scale. To learn more about how `rem` works and why we use it, see the [Units page](https://developers.webflow.com/flowkit/getting-started/units).
...
- iconis-small
- flex\_horizontalgap-small
- padding-bottom\_small
- margin-top\_small
