...
category: general
url: https://developers.webflow.com/designer/reference/set-asset-file
title: "Set Asset File | Webflow Developer Documentation"
...
- **`fileBlob`**: _File_ \- The file to set the asset to.
