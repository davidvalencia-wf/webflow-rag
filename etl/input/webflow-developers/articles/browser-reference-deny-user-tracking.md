...
category: general
url: https://developers.webflow.com/browser/reference/deny-user-tracking
title: "Deny user tracking | Webflow Developer Documentation"
...
- **options?**: _object_ \- Controls deactivation behavior. Optional.
  - **reload?**: _boolean_ \- Reloads the page after disabling tracking. _Default: false_
