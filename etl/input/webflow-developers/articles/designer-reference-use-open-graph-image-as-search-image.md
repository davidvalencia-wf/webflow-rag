...
category: general
url: https://developers.webflow.com/designer/reference/use-open-graph-image-as-search-image
title: "Use Open Graph image as search image | Webflow Developer Documentation"
...
- **use**: _`boolean`_ \- Whether to use the Open Graph image as the search image.
