...
category: general
url: https://developers.webflow.com/apps/docs/publishing-your-app
...
[1](https://developers.webflow.com/apps/docs/publishing-your-app#build-and-bundle-your-extension)
...
[2](https://developers.webflow.com/apps/docs/publishing-your-app#upload-your-extension-bundle)
...
[3](https://developers.webflow.com/apps/docs/publishing-your-app#test-your-uploaded-extension)
...
The Webflow team will review your submission to ensure it follows our [Developer Terms of Service](https://developers.webflow.com/apps/developer-terms-of-service) and meets our [Marketplace Guidelines](https://developers.webflow.com/apps/docs/marketplace-guidelines). This process can take a few days, and you’ll receive an email notification once it’s approved.
...
You can share your extension outside of your Workspace by submitting it to the Webflow Marketplace. If you want to test with a limited group of users before a full public release, you can also [submit your app to be reviewed as a private app](https://developers.webflow.com/apps/docs/private-apps).
