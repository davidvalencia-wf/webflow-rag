...
category: general
url: https://developers.webflow.com/devlink/docs/component-export/whats-exported
title: "What DevLink Exports | Webflow Developer Documentation"
...
Footer.jsxFooter.d.tsFooter.module.css
...
[Styling Components\\
\\
Learn how to style components for reliable export](https://developers.webflow.com/code-components/styling-components) [Using Components\\
\\
Learn how to use the components you’ve exported.](https://developers.webflow.com/code-components/styling-components)
...
Yes. By default, DevLink exports React components as `.js` files. You can change the file extensions of the exported components and styles by modifying the `fileExtensions` setting in your [DevLink configuration file](https://developers.webflow.com/devlink/docs/component-export/installation#create-a-configuration-file).
