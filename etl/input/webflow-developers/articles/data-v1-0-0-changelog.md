...
category: general
url: https://developers.webflow.com/data/v1.0.0/changelog
title: "Changelog | Webflow Developer Documentation"
published: 2025-11-17
---

[October 8, 2025](https://developers.webflow.com/data/v1.0.0/changelog/1082025)

beta

## [New LLMS.txt endpoints, Audit Log events, and Google Tag support](https://developers.webflow.com/data/v1.0.0/changelog/1082025)
...
[September 4, 2025](https://developers.webflow.com/data/v1.0.0/09042025)

## [Webflow's MCP server now supports the Designer](https://developers.webflow.com/data/v1.0.0/09042025)
...
See the [Node.js compatibility section](https://developers.webflow.com/data/v1.0.0/docs/ai-tools#nodejs-compatibility) for detailed troubleshooting steps.

## Learn more

For complete setup instructions, tool documentation, and troubleshooting guides, see our [MCP server and AI tools documentation](https://developers.webflow.com/data/v1.0.0/docs/ai-tools).

* * *

[August 12, 2025](https://developers.webflow.com/data/v1.0.0/changelog/2025/8/12)

## [Changes for internal APIs affecting site data sync in the browser](https://developers.webflow.com/data/v1.0.0/changelog/2025/8/12)
...
[1](https://developers.webflow.com/data/v1.0.0/changelog#august-13-2025)

### August 13, 2025

This set of internal APIs will start returning and accepting version fields for reads and writes

[2](https://developers.webflow.com/data/v1.0.0/changelog#august-19-2025)
...
[3](https://developers.webflow.com/data/v1.0.0/changelog#september-15-2025)

### September 15, 2025

This set of internal APIs will start enforcing version checks on all writes

[4](https://developers.webflow.com/data/v1.0.0/changelog#late-2026)
...
[1](https://developers.webflow.com/data/v1.0.0/changelog#1-update-data-retrieval)
...
[2](https://developers.webflow.com/data/v1.0.0/changelog#2-update-data-writing)
...
[3](https://developers.webflow.com/data/v1.0.0/changelog#3-handle-version-conflicts)
...
[August 8, 2025](https://developers.webflow.com/data/v1.0.0/changelog/08082025)

## [Developer experience improvements](https://developers.webflow.com/data/v1.0.0/changelog/08082025)
...
[June 23, 2025](https://developers.webflow.com/data/v1.0.0/changelog/06232025)

## [Breaking changes for CMS publishing](https://developers.webflow.com/data/v1.0.0/changelog/06232025)
...
[May 13, 2025](https://developers.webflow.com/data/v1.0.0/changelog/05132025-mcp-server)

## [Webflow MCP Server Version Update to 0.5.1](https://developers.webflow.com/data/v1.0.0/changelog/05132025-mcp-server)
...
[May 8, 2025](https://developers.webflow.com/data/v1.0.0/changelog/05082025)

## [Workspace audit logs and improvements for Webflow Apps](https://developers.webflow.com/data/v1.0.0/changelog/05082025)
...
[April 8, 2025](https://developers.webflow.com/data/v1.0.0/changelog/04082025-mcp-server)

## [Introducing Webflow's official MCP server and LLMS.txt support](https://developers.webflow.com/data/v1.0.0/changelog/04082025-mcp-server)
...
[April 8, 2025](https://developers.webflow.com/data/v1.0.0/changelog/04082025)

## [Introducing the Comments API](https://developers.webflow.com/data/v1.0.0/changelog/04082025)
...
[March 12, 2025](https://developers.webflow.com/data/v1.0.0/changelog/2025/3/12)

## [Support for option fields](https://developers.webflow.com/data/v1.0.0/changelog/2025/3/12)
