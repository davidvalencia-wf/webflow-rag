...
category: general
url: https://developers.webflow.com/flowkit/components/accordion
title: "Accordion | Webflow Developer Documentation"
...
| Class | Purpose |
| --- | --- |
| accordion\_toggle | Button that triggers the open/close behavior |
| accordion\_content | The content area that expands/collapses |
