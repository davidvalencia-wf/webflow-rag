...
/**
 * PRODUCTION SCRAPER: Webflow Blog Posts Articles
 *
...
const CONFIG = {
  ...
  URL_LIST_FILE: path.join(__dirname, 'curated-blog-urls.json'),
  OUTPUT_DIR: path.join(__dirname, 'input/webflow-blog'),
  ARTICLES_DIR: path.join(__dirname, 'input/webflow-blog/articles'),
  BATCH_SIZE: 10,
  RETRY_ATTEMPTS: 2,
 ...
 */
async function main() {
  console.log('🚀 STARTING PRODUCTION SCRAPE: Webflow Blog Posts');
