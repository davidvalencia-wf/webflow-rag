...
/**
 * PRODUCTION SCRAPER: Webflow API Documentation Articles
 *
...
const CONFIG = {
  ...
  URL_LIST_FILE: path.join(__dirname, 'curated-api-docs-urls.json'),
  OUTPUT_DIR: path.join(__dirname, 'input/webflow-api-docs'),
  ARTICLES_DIR: path.join(__dirname, 'input/webflow-api-docs/articles'),
  BATCH_SIZE: 10,
  RETRY_ATTEMPTS: 2,
 ...
 */
async function main() {
  console.log('🚀 STARTING PRODUCTION SCRAPE: Webflow API Documentation');
